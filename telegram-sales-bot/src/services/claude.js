...
- Выручка MTD и количество заказов (ТОЛЬКО из данных!)
- DRR % (доля рекламных расходов)
- 🔥 Топ-3 товара (названия и выручка)
- ✅ Что классно (1 пункт на основе данных)
- ⚠️ На что обратить внимание (1 пункт)

ВАЖНО: НЕ придумывай данные! Используй ТОЛЬКО цифры из <data>. Нет плана - не пиши про план!
